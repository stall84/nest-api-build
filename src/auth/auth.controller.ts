 ...
 * @NOTE More on Dependency Injection : // Use dependency-injection provided by Nest to furnish an 'instance' of the Auth Service
 ...
 *
 * @NOTE DTO's: // Nest provides the ability to easily construct Data Transfer Objects (DTO) which is an object the
